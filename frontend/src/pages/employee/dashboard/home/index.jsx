...
const DashboardHome = () => {
  ...
  return (
    <div className="min-h-screen px-4 py-4 sm:px-6 sm:py-6 lg:ml-16 bg-light-bg text-light-text dark:bg-dark-bg dark:text-dark-text transition-colors duration-300">
