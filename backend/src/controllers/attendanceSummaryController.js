    ...
    const summary = await Attendance.aggregate([
      ...
      { $unwind: '$employeeDetails' },
      {
        $project: {
          ...
          recessStartLocation: { $ifNull: ['$recessStartLocation', 'N/A'] },
          recessEndLocation: { $ifNull: ['$recessEndLocation', 'N/A'] },
          recessSessions: { $ifNull: ['$recessSessions', []] },
  ...
  try {
    ...
    if (req.user.role === 'admin' && !employeeId) {
      ...
      const attendanceData = records.map((record) => {
        ...
        return {
          ...
          recessStartLocation: record.recessStartLocation || 'N/A',
          recessEndLocation: record.recessEndLocation || 'N/A',
          recessSessions: record.recessSessions || [],
    ...
    for (const dateKey of holidaySet) {
      ...
      syntheticHolidayRecords.push({
        ...
        recessStartLocation: 'N/A',
        recessEndLocation: 'N/A',
        recessSessions: [],
        totalWorkingTime: 0,
